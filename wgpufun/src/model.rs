...
impl Vertex {
	...
	pub fn layout() -> VertexBufferLayout<'static> {
		...
		//had to split this out into a separate field and explicity mark it as a 'static reference... okay
		static ATTRS: &'static [VertexAttribute] = &vertex_attr_array![0 => Float3, 1 => Float3];
